...
namespace LetMeSleep.Presentation.Editor
{
    public static class AlfaPresentationBuilder
    {
        ...
        private static Dictionary<string, AudioCue> BuildAudioCues(AudioMixer mixer)
        {
            ...
            cues["MosquitoWingLoop"] = CreateCue("MosquitoWingLoop", "SFX_Legacy_Buzz_Flight.ogg", 56, 12, 0.98f, 1.02f, 1f, 0.35f, 12f, FindGroup(mixer, "Mosquito"), true);
            var flightCue = new SerializedObject(cues["MosquitoWingLoop"]);
            flightCue.FindProperty("volume").floatValue = 0.35f;
            flightCue.ApplyModifiedPropertiesWithoutUndo();
            ...
            cues["HumanFootstep"] = CreateCue("HumanFootstep", "SFX_Legacy_Step_Wood.ogg", 80, 12, 0.98f, 1.02f, 1f, 0.7f, 15f, characterGroup);
            cues["HumanFootstepTile"] = CreateCue("HumanFootstepTile", "SFX_Legacy_Step_Tile.ogg", 80, 12, 0.98f, 1.02f, 1f, 0.7f, 15f, characterGroup);
            cues["HumanFootstepCloth"] = CreateCue("HumanFootstepCloth", "SFX_Legacy_Step_Cloth.ogg", 80, 12, 0.98f, 1.02f, 1f, 0.7f, 15f, characterGroup);
