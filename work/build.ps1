...
if (-not $SkipTests) {
    ...
    foreach ($testName in @('modeler091_layout_test','modeler091_furnishing_regression','environment091_stair_lighting_test','environment091_v2_finish_test','review091_online_cosmetics_contract')) {
        Invoke-CheckedHeadless -CheckName $testName -GameArguments @('--script',"res://tests/$testName.gd")
    }
