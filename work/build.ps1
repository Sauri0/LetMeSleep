...
if (-not $SkipTests) {
    ...
    foreach ($testName in @('surface09_test','surface_view09_test','emote09_authority_test','procedural09_test','geometry09_cache_checks','map_tasks09_test','voice09_acoustics_checks','voice09_pcm_test','audio09_listener_checks','network09_map_social_checks','network09_view_ack_checks','network09_voice_checks')) {
        Invoke-CheckedHeadless -CheckName $testName -GameArguments @('--script',"res://tests/$testName.gd")
    }
