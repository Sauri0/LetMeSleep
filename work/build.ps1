...
if (-not $SkipTests) {
    ...
    foreach ($testName in @('modeler091_layout_test','environment091_stair_lighting_test','review091_house_contract','review091_motion_combat_contract','review091_online_cosmetics_contract')) {
        Invoke-CheckedHeadless -CheckName $testName -GameArguments @('--script',"res://tests/$testName.gd")
    }
