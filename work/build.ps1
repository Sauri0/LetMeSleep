...
if (-not $SkipTests) {
    ...
    foreach ($testName in @('maps_test','route_tests','locomotion_test','focus_combat_test','task_deadline_test','practice_test','invitation_test','network_order_test','network_privacy_audit_test','ui_navigation_test','preferences_migration_test')) {
