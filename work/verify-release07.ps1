...
if ($Suite -eq 'native') {
    ...
    foreach ($test in @('audio09_redundancy_checks','hud09_coalescing_checks','skin09_visibility_checks','human09_presentation_test','stun_help_test','surface09_test','emote09_authority_test','procedural09_test','map_tasks09_test','voice09_acoustics_checks','voice09_pcm_test','network09_map_social_checks','network09_view_ack_checks','network09_voice_checks')) {
