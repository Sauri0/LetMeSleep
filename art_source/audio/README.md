# Let me sleep — fuente de audio 0.6
...
- `game/assets/audio/manifest.json`, `CREDITS.txt` y `LICENSE-VSCO2CE-CC0.txt`: manifiesto de los 48 OGG y procedencia para distribución.
