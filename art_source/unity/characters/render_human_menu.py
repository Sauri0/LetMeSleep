...
def main():
    ...
    scene.render.resolution_x=480 if args.sequence else 960;scene.render.resolution_y=360 if args.sequence else 720
    ...
    def render(label,clip,phase,yaw):
        ...
        a=math.radians(yaw);focus=Vector((0,-.18,.87));camera.location=focus+Vector((math.sin(a)*5,-math.cos(a)*5,1.0))
