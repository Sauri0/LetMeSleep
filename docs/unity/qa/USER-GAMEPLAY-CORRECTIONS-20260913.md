...
| F fija la mirada; piso/pared/techo/objetos | Gameplay: orientación y transporte por superficie en preparación. | Pendiente contacto real, bordes, objetos móviles y cancelación; no aprobado. |
...
| Parpadeo deforma mentón/cachetes | Humanos: diagnóstico de normales importadas y corrección en preparación. | 30 muestras BakeMesh sin desplazamiento fuera de párpados. Normales de mentón hasta 116.565° y cachete 51.252° al parpadear: defecto medido de iluminación. Falta corregir y comparar renders antes/después. |
