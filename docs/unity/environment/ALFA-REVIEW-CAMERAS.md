...
Las posiciones de cámara siguen derivadas de esa geometría; la configuración alfa posterior inicia las nueve puertas abiertas a 100°. Capturar primero ese estado real del prefab. Para revisar hojas cerradas, reutilizar **la misma cámara 04** en una segunda captura con DiningDoor/KitchenDoor a 0° mediante GameplayDoor.ApplyAngle(0); restaurar 100° al terminar mediante ApplyAngle(100 * Mathf.Deg2Rad), que ya aplica OpenSign=-1, sin guardar la variante cerrada. Esto revisa visualmente extremos del giro; la trayectoria intermedia necesita prueba en movimiento.
