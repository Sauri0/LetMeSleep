...
La segunda consulta nativa del Director, N:/Unity/Setup/door-world-check.json, confirmó Z reflejado: pivote (.585,0,-.045), hoja (1.12,1.1025,-.045), shell desde(-.18,-.18,-4.579999) hasta(4.98,3,.18). El builder comprueba primero la convención prevista —pivote en z=-0.045 y shell en z=-4.58…0.18— y falla explícitamente si no coincide. No se elimina ni relaja el gate para aceptar coordenadas desconocidas.
...
Parche ejecutado por Director con éxito nativo el12/09/2026 a09:54:43Z:55meshes/45colliders/10materiales/13anchors, conversión por vértice y bounds de puerta0/-100 concordantes. Recibo en main docs/unity/environment/UNITY-IMPORT-RECEIPT.json. Continúan pendientes render visual, UV2 tras bake, controlador y cámara.
