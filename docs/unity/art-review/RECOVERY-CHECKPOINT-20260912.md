...
Actualización 2026-09-13 00:04 UTC: HEAD b15fc12 integra regla ocular: radio3D2m, cono120grados, mismo candidato más cercano2s continuos; fallbackViewForward y parpadeo/micromovimientos.14checksCPU centrales y4casos adaptador nativo frente/detrás/afuera/otraespecie pasan (N:/LetMeSleep/Validation/NearestAttention-20260912). Native usó posiciones visuales controladas; no prueba WAN. Menú pasó a SampleLate900 para impedir sobrescritura Animator posteriorUpdate, cabeza/cuello con límitecombinado; lucesfrontales. Repetición16s quedó con frame1 fijo por editor no avanzando: NO certifica animación en movimiento; no reutilizar esa evidencia como PASS. Preparar ejecutable para validación real. Unity7716 enEdit/noaudio; runInBackground habilitado para continuidad de anfitrión. Personajes/mapas/bootstrap ya reconstruidos; generatedassets pendientes de sellar. Versión nueva alfa.3.
